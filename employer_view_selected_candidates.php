<?php
	...
	if ($_SERVER['REQUEST_METHOD'] == 'GET')
	{
		...
		/* Close db connection */
		mysqli_close($con);
		//header('location:employer_view_selected_candidates.php');
	}
...
<!-- Main -->
	<div id="main">
		...
		<form method="get" action="#" enctype="multipart/form-data">
			...
			<div id="main">
				<!-- Job List -->
				<section id="selected_candidates_list" name="selected_candidates_list" class="main">
					<h2>Selected Candidates</h2>
					<?php
					if (mysqli_num_rows($selected_candidates)==0) { echo "Noting to Show..!"; }
					else
					{
						while($row = mysqli_fetch_array($$selected_candidates))
						{
